...
class TestHagerZhang(unittest.TestCase):
    ...
    def test_hz_line_search_expands(self):
        ...
        _, _, _, alpha, _, ok = _core._line_search_hz(
            f, x0, d, f0, g0, 0.5, Params(line_search="hz")
        )
        self.assertTrue(ok)
    ...
    def test_hz_line_search_overshoot(self):
        ...
        _, _, _, alpha, _, ok = _core._line_search_hz(f, x0, d, f0, g0, 1000.0, p)
        self.assertTrue(ok)
        self.assertTrue(_wolfe_holds(f, x0, d, alpha))
